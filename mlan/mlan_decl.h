...
#define MLAN_RELEASE_VERSION		"485"
...
typedef enum _mlan_status {
	MLAN_STATUS_FAILURE = -0x00000001,//0xffffffff,
...
typedef enum _mlan_error_code {
	...
	MLAN_ERROR_PKT_SIZE_INVALID = -0x7FFFFFFF,//0x80000001,
	MLAN_ERROR_PKT_TIMEOUT = -0x7FFFFFFE,//0x80000002,
	MLAN_ERROR_PKT_INVALID = -0x7FFFFFFD,//0x80000003,
	MLAN_ERROR_CMD_INVALID = -0x7FFFFFFC,//0x80000004,
	MLAN_ERROR_CMD_TIMEOUT = -0x7FFFFFFB,//0x80000005,
	MLAN_ERROR_CMD_DNLD_FAIL = -0x7FFFFFFA,//0x80000006,
	MLAN_ERROR_CMD_CANCEL = -0x7FFFFFF9,//0x80000007,
	MLAN_ERROR_CMD_RESP_FAIL = -0x7FFFFFF8,//0x80000008,
	MLAN_ERROR_CMD_ASSOC_FAIL = -0x7FFFFFF7,//0x80000009,
	MLAN_ERROR_CMD_SCAN_FAIL = -0x7FFFFFF6,//0x8000000A,
	MLAN_ERROR_IOCTL_INVALID = -0x7FFFFFF5,//0x8000000B,
	MLAN_ERROR_IOCTL_FAIL = -0x7FFFFFF4,//0x8000000C,
	MLAN_ERROR_EVENT_UNKNOWN = -0x7FFFFFF3,//0x8000000D,
	MLAN_ERROR_INVALID_PARAMETER = -0x7FFFFFF2,//0x8000000E,
	MLAN_ERROR_NO_MEM = -0x7FFFFFF1,//0x8000000F,
    /** More to add */
} mlan_error_code;
...
typedef enum _mlan_event_id {
	...
	MLAN_EVENT_ID_DRV_CONNECTED = -0x7FFFFFFF,//0x80000001,
	MLAN_EVENT_ID_DRV_DEFER_HANDLING = -0x7FFFFFFE,//0x80000002,
	MLAN_EVENT_ID_DRV_HS_ACTIVATED = -0x7FFFFFFD,//0x80000003,
	MLAN_EVENT_ID_DRV_HS_DEACTIVATED = -0x7FFFFFFC,//0x80000004,
	MLAN_EVENT_ID_DRV_MGMT_FRAME = -0x7FFFFFFB,//0x80000005,
	MLAN_EVENT_ID_DRV_OBSS_SCAN_PARAM = -0x7FFFFFFA,//0x80000006,
	MLAN_EVENT_ID_DRV_PASSTHRU = -0x7FFFFFF9,//0x80000007,
	MLAN_EVENT_ID_DRV_SCAN_REPORT = -0x7FFFFFF7,//0x80000009,
	MLAN_EVENT_ID_DRV_MEAS_REPORT = -0x7FFFFFF6,//0x8000000A,
	MLAN_EVENT_ID_DRV_ASSOC_FAILURE_REPORT = -0x7FFFFFF5,//0x8000000B,
	MLAN_EVENT_ID_DRV_REPORT_STRING = -0x7FFFFFF1,//0x8000000F,
	MLAN_EVENT_ID_DRV_DBG_DUMP = -0x7FFFFFEE,//0x80000012,
	MLAN_EVENT_ID_DRV_BGSCAN_RESULT = -0x7FFFFFED,//0x80000013,
	MLAN_EVENT_ID_DRV_FLUSH_RX_WORK = -0x7FFFFFEB,//0x80000015,
	MLAN_EVENT_ID_DRV_DEFER_RX_WORK = -0x7FFFFFEA,//0x80000016,
} mlan_event_id;
...
#define MAX_MGMT_IE_INDEX               10//16
